...
const movimentacoes_services_1 = __importDefault(require("../services/movimentacoes.services"));
const statusCodes_1 = __importDefault(require("../statusCodes"));
class MovimentacoesController {
    constructor(movimentacoesService = new movimentacoes_services_1.default()) {
