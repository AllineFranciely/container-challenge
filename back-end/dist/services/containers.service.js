...
const containers_models_1 = __importDefault(require("../models/containers.models"));
const restify_errors_1 = require("restify-errors");
const properties = ['cliente', 'numero', 'tipo', 'situacao', 'categoria'];
class ContainersService {
    constructor() {
        this.model = new containers_models_1.default(connection_1.default);
    }
    ...
    static validationContainer(container) {
    ...
    create(container) {
        const isValidContainer = ContainersService.validationContainer(container);
